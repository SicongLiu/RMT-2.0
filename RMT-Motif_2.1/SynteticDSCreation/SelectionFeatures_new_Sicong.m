...
FeaturePath = '/Users/sliu104/Desktop/Motif_Data/Features_RMT/';
Dset='Mocap';%'BirdSong';%'Energy';%'BirdSong';%Bird Song %'ASL';%'data';%for Mocap
DestDataPath = ['/Users/sliu104/Desktop/Motif_Data/SynteticDataset/',Dset,'/'];
...
DepO = 2;
DepT = 2;
nummotifs = 1; % number of RMT features to be selected
TSConsidered = 1; % 90;
